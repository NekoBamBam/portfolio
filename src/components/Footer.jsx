...
const MailButton = () => {
  const mailtoLink =
    "mailto:corinnicolas21@gmail.com?subject=Asunto%20del%20correo&body=Hola%20aquí%20va%20el%20mensaje";
};
const Footer = () => {
  return (
      ...
      <div className="container mx-auto px-6 ">
        <div className="flex flex-col md:flex-row justify-end items-center space-y-6 md:space-y-0">
          ...
          <div className="w-full">
            <div className="flex flex-col md:flex-row space-y-4 place-content-evenly md:space-y-0 md:space-x-10 text-center">
          ...
          {/* Redes sociales */}
          <div className=" right-0 grid grid-cols-2 gap-6">
            <a
